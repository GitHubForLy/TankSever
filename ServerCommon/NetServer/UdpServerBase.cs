...
//    /// 表示一个异步套接字服务
//    /// </summary>
//    public abstract class UpdServerBase : NotifyServer, IDisposable
//    {
...
//        public UpdServerBase() : this(100) { }

//        public UpdServerBase(int MaxConnections):this(MaxConnections,null){}

//        public UpdServerBase(int MaxConnections, INotifier notifier) : base(notifier)
//        {
...
//            IsClosed = false;
//            m_listenSocket = new Socket(localEP.AddressFamily, SocketType.Dgram, ProtocolType.Udp);
